 ...
 */
export const prose = {
	p: "m-0 mb-5 max-w-[68ch] break-words font-nota text-lg leading-relaxed",
	...
	ul: "mb-5 max-w-[68ch] list-inside list-disc space-y-1 pl-5 font-nota text-lg leading-relaxed",
	ol: "mb-5 max-w-[68ch] list-inside list-decimal space-y-1 pl-5 font-nota text-lg leading-relaxed",
	li: "break-words",
