...
const DICT = {
	es: {
		...
		blog: {
			...
			etiqueta: "Etiqueta",
			porEtiqueta: (tag: string) => `Notas etiquetadas “${tag}”`,
			verTodas: "Ver todas las notas",
	...
	en: {
		...
		blog: {
			...
			etiqueta: "Tag",
			porEtiqueta: (tag: string) => `Notes tagged “${tag}”`,
			verTodas: "See all notes",
			anterior: "Previous note",
			siguiente: "Next note",
		},
		sobreMi: {
			titulo: "About me",
