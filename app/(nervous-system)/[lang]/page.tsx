...
import CareerSection from "../../src/sections/CareerSection";
import NorteArSection from "../../src/sections/NorteArSection";
import RecommendationsSection from "../../src/sections/RecommendationsSection";
...
const HomePage = async ({ params }: { params: Promise<{ lang: Language }> }) => {
	...
	return (
		<main>
			...
			<ContactSection d={d} lang={lang} discardedData={discardedData} />

			<footer className='pointer-events-none px-5 pb-16 md:px-10 lg:px-16'>
				<div
					data-reveal
					className='pointer-events-auto ml-auto flex w-full max-w-[42rem] flex-wrap items-end justify-between gap-6 border-t border-synapse/30 pt-5 font-mono text-xs text-myelin md:w-[54%]'>
